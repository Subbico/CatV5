...
pcall(delfolder, "catrewrite/assets/trash")
...
local getText = function(language, text)
	return game:HttpGet('https://raw.githubusercontent.com/Subbico/CatV5/'..readfile('catrewrite/profiles/commit.txt')..'/'.. 'translations/'.. language.. '/'.. text .. '.txt')
end
